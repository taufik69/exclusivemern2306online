          ...
          {[...new Array(Math.ceil(totalPage) || 8)].map((_, index) => (
            <li>
              <span
                ...
                className={
                  index + 1 === page
                    ? "flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-redDB4444 border border-gray-300 hover:bg-gray-100 hover:text-gray-700  cursor-pointer"
